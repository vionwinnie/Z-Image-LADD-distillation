...
class LADDDiscriminator(nn.Module):
    ...
    def __init__(
        ...
        # Project text embed (feature_dim) -> cond_dim
        self.text_proj = nn.Linear(feature_dim, cond_dim)
    ...
    def forward(
        ...
        for layer_idx in self.layer_indices:
            ...
            # Extract image features and pooled text
            ...
            text_embed = self.text_proj(text_pooled)  # (B, cond_dim)
